...
namespace WalkGame.Gameplay
{
    ...
    public sealed class RewardApplier
    {
        ...
        {
            // Checked add with saturation on overflow; preserves monotonicity for canonical progress.
            try { return checked(a + b); } catch (OverflowException) { return b > 0 ? long.MaxValue : long.MinValue; }
        }
